...
你可以不和团队发生任何联系，也能让 Git 发挥功能，帮你储存项目关键时间节点，用于查看、回溯等操作。我们不是为了协作而使用 Git，我们是为了让创作过程「有迹可循」，培养大家的好习惯。就像那些能记录绘画过程的软件，除了创作结果，不觉得创作记录本身也很酷么？
...
这部分才是团队协作的体现，个人分支通过 PR 传给主分支，同时更新来自主分支的改动，构成了「个人」和「团队」的协同。PR 也确保了个人内容被单向的、有监督地并入，保障了安全性、稳定性。

...
本地改动，有选择性地、有监督地被同步到项目。有效避免同步盘方案下，高频改动文件的冲突和 AI 无法参与的尴尬。这样，即能放心大胆在本地创作，又规范谨慎地管理项目，还解决了私有盘无法分享的问题。

接下来，我将详细描述操作步骤，建议跟着来一遍
...
手动输入 Commit Message 来说明改动了什么，或者点击小星按钮让 AI 来帮忙总结。最后点击 Commit 按钮，完成「提交」。至此改动才被确认，记录到了 Git History 中。

...
有效避免同步盘方案下，高频改动文件的冲突和 AI 无法参与的尴尬。这样，即释放了本地创作的限制，又规范了线上协作的管理，还解决了私有盘无法分享的问题。
...
这是工作中最常见的循环：一边工作，一边适时地 add > commit > push
...
合并请求（Pull Request，简称 PR）就是申请「个人分支」改动并入「主分支」
